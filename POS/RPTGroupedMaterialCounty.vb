...
Public Class RPTGroupedMaterialCounty
...
INNER Join county ON county.County_No = delivery_details.CountyId Where County_No = @d3 Group By Item_No"
    ...
    Private Sub CountyID()
        ...
        End Try
    End Sub
    Private Sub RPTGroupedMaterialCounty_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadCountyName()
    End Sub

    Private Sub LoadGroupedMaterialsPerCounty()
        Populatelistview()
        Dim Ds1 As New DataSet1
        Dim drow As DataRow
        Dim i As Integer
        For i = 0 To ListView1.Items.Count - 1
            drow = Ds1.Tables("GroupedMaterialsPerCounty").NewRow()
            ...
            drow("County_Name") = ListView1.Items(i).SubItems(4).Text
            Ds1.Tables("GroupedMaterialsPerCounty").Rows.Add(drow)
        Next i
        Dim freport As New RPTMaterialIssueScheme
        Me.ReportViewer1.Reset()
        Me.ReportViewer1.ProcessingMode = Microsoft.Reporting.WinForms.ProcessingMode.Local
        Dim exeFolder As String = Application.StartupPath
        Me.ReportViewer1.LocalReport.ReportPath = Path.Combine(exeFolder, "GroupedMaterialssuancePerCounty.rdlc")
        'Me.ReportViewer1.LocalReport.ReportPath = "C:\Users\joshua\Desktop\MM\POS\GroupedMaterialssuancePerCounty.rdlc"
        Me.ReportViewer1.LocalReport.DataSources.Clear()
        Me.ReportViewer1.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("DataSet1", Ds1.Tables("GroupedMaterialsPerCounty")))
    ...
    Private Sub BTNLoadMaterialReport_Click(sender As Object, e As EventArgs) Handles BTNLoadMaterialReport.Click
        LoadGroupedMaterialsPerCounty()
    End Sub
End Class