...
Public Class RPTMaterialIssueConstituency
...
INNER Join county ON county.County_No = delivery_details.CountyId Where Constituency_No = @d1"
        ...
        End Try
    End Sub
    Private Sub LoadReportPerConstituency()
        Populatelistview()
        Dim Ds1 As New DataSet1
        Dim drow As DataRow
        Dim i As Integer
        For i = 0 To ListView1.Items.Count - 1
            drow = Ds1.Tables("MaterialsPerConstituency").NewRow()
            ...
            drow("constituency_Name") = ListView1.Items(i).SubItems(6).Text
            Ds1.Tables("MaterialsPerConstituency").Rows.Add(drow)
        Next i
        Dim freport As New RPTMaterialIssueScheme
        Me.ReportViewer1.Reset()
        Me.ReportViewer1.ProcessingMode = Microsoft.Reporting.WinForms.ProcessingMode.Local
        Dim exeFolder As String = Application.StartupPath
        Me.ReportViewer1.LocalReport.ReportPath = Path.Combine(exeFolder, "MaterialIssueperConstituency.rdlc")
        'Me.ReportViewer1.LocalReport.ReportPath = "C:\Users\joshua\Desktop\MM\POS\MaterialIssueperConstituency.rdlc"
        Me.ReportViewer1.LocalReport.DataSources.Clear()
        Me.ReportViewer1.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("DataSet1", Ds1.Tables("MaterialsPerConstituency")))
    ...
    Private Sub RPTMaterialIssueConstituency_Load(sender As Object, e As EventArgs) Handles MyBase.Load
