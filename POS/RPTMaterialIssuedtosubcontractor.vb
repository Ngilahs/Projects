...
Public Class RPTConsolidatedMaterialsIssuedtosub
...
INNER Join county ON county.County_No = delivery_details.CountyId where ContractorId = @d1 Group By Item_No, SchemeId"
            cmd = New MySqlCommand(Query, MysqlConn)
            cmd.Parameters.AddWithValue("@d1", txtSubcontractor.Text)
    ...
    Private Sub cboSubcontractor_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboSubcontractor.SelectedIndexChanged
        LoadSubcontractorID()
    End Sub
    Private Sub RPTConsolidatedMaterialsIssuedtosub_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadSubcontractors()
    End Sub
