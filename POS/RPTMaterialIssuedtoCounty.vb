...
Public Class RPTMaterialIssuedtoCounty
...
INNER Join county ON county.County_No = delivery_details.CountyId where CountyId = @d1 Group By Item_No, SchemeId"
    ...
    Private Sub CountyID()
        ...
        End Try
    End Sub
    Private Sub RPTMaterialIssuedtoSubCon_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadCountyName()
    End Sub

    Private Sub cboSubcontractor_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboCounty.SelectedIndexChanged
        CountyID()
    End Sub
    ...
    Private Sub BTNLoadExpensereport_Click(sender As Object, e As EventArgs) Handles BTNLoadExpensereport.Click
        ...
        Me.ReportViewer1.LocalReport.ReportPath = Path.Combine(exeFolder, "MaterialIssuedtosubcontractor.rdlc")
