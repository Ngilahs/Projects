...
Public Class frmListofInvoices
    Dim y As Integer
    ...
    Private Sub LoadStatements()
        ...
        Try
            ...
            Query = "SELECT
                    ...
                    INNER JOIN subcategory ON subcategory.SubcategoryID = tbl_billingparameters.subcatID
                    INNER JOIN schemes ON schemes.SchemeNo = tbl_billingdetails.SchemeID
                    INNER JOIN tbl_subcontractors ON tbl_subcontractors.subcontractors_ID = tbl_billingdetails.Sub_contractorID Group By tbl_billingdetails.BillingdetailID"
            cmd = New MySqlCommand(Query, MysqlConn)
            dr = cmd.ExecuteReader
            dgw1.Rows.Clear()
            y = 0
        ...
        End Try
    End Sub
    Private Sub frmListofInvoices_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadStatements()
        GetTotal()
    End Sub
    ...
    Private Sub btnLCSExportExcel_Click(sender As Object, e As EventArgs) Handles btnLCSExportExcel.Click
        ...
        End Try
    End Sub
    Private Sub LoadStatementswithBOQs()
        Dim MysqlConn As MySqlConnection
        Dim cmd As MySqlCommand
        MysqlConn = New MySqlConnection
        MysqlConn = New MySqlConnection(ConfigurationManager.ConnectionStrings("POS").ConnectionString)
