...
Public Class RPTGroupMaterialPerScheme
...
INNER Join county ON county.County_No = delivery_details.CountyId Where SchemeNo = @d1 GROUP BY Item_No"
    ...
    Private Sub LoadGroupedMaterialReport()
        ...
        For i = 0 To ListView1.Items.Count - 1
            drow = Ds1.Tables("GroupedMaterialsPerScheme").NewRow()
            ...
            drow("Date_Issued") = ListView1.Items(i).SubItems(4).Text
            drow("Scheme_Name") = ListView1.Items(i).SubItems(5).Text
            Ds1.Tables("GroupedMaterialsPerScheme").Rows.Add(drow)
        Next i
        Dim freport As New RPTMaterialIssueScheme
        Me.ReportViewer1.Reset()
        Me.ReportViewer1.ProcessingMode = Microsoft.Reporting.WinForms.ProcessingMode.Local
        Dim exeFolder As String = Application.StartupPath
        Me.ReportViewer1.LocalReport.ReportPath = Path.Combine(exeFolder, "GroupedMaterialIssuanceperscheme.rdlc")
        'Me.ReportViewer1.LocalReport.ReportPath = "C:\Users\joshua\Desktop\MM\POS\GroupedMaterialIssuanceperscheme.rdlc"
        Me.ReportViewer1.LocalReport.DataSources.Clear()
        Me.ReportViewer1.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("DataSet1", Ds1.Tables("GroupedMaterialsPerScheme")))
    ...
    Private Sub RPTGroupMaterialPerScheme_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadSchemeName()
    End Sub
    Private Sub BTNLoadGrpMaterial_Click(sender As Object, e As EventArgs) Handles BTNLoadGrpMaterial.Click
