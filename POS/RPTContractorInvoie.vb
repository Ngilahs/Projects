...
Public Class RPTContractorInvoie
    ...
    'INNER JOIN tbl_subcontractors ON tbl_billingdetails.Sub_contractorID = tbl_subcontractors.subcontractors_ID Where BillingdetailID = @d1 and tbl_billingitems.Qty > 0"
    ...
    '        End Try
    '    End Sub
    '    Private Sub RPTContractorInvoie_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    '        InvoiceNo()
    '    End Sub
    ...
    '        Me.Name = "RPTContractorInvoie"
    '        Me.ResumeLayout(False)

    '    End Sub

    '    Private Sub RPTContractorInvoie_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
