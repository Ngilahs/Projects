...
Public Class RPTSchemeMeterList
    Private Sub RPTSchemeMeterList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadSchemeName()
    ...
    Public Sub Populatelistview()
        ...
        Try
            ...
            Query = "SELECT
                    ...
                    INNER Join county ON county.County_No = schemes.County_Id where tbl_meterrvcd_info.SchemeID = @d1"
    ...
    Private Sub LoadExpensesReport()
        ...
        Me.ReportViewer1.LocalReport.ReportPath = Path.Combine(exeFolder, "RPTCustomerList.rdlc")
        'Me.ReportViewer1.LocalReport.ReportPath = "F:\DesktopB4Format\MM\POS\RPTCustomerList.rdlc"
